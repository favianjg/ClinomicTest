"""
Django settings for ClinomicTest project.
...
SECRET_KEY = '6e8vgpp=i_aufo%&+(ry()f35!%nc$i7=tax98g3yqwpy+#j=*'
...
ROOT_URLCONF = 'ClinomicTest.urls'
...
WSGI_APPLICATION = 'ClinomicTest.wsgi.application'
